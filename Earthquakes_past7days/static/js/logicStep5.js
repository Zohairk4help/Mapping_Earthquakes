...
function styleInfo(feature) {
  return {
    opacity: 1,
    fillOpacity: 1,
    fillColor: getColor(feature.properties.mag), // [13.6.3]
    color: "#000000",
...
// Creating a GeoJSON layer with the retrieved data. & change the basic marker to a circleMarker 
// by using the pointToLayer function. [13.6.2]
L.geoJSON(data, {
  ...
  pointToLayer: function(feature, latlng) {
        ...
        // Create a legend control object. [13.6.5]
...
legend.onAdd = function () {
  ...
  // loop through our density intervals and generate a label with a colored square for each interval [13.6.5]
